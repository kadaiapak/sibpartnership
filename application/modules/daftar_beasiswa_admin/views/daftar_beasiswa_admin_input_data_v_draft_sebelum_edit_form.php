                                                    ...
                                                    <div class="card card-warning p-3 text-center">
                                                        ...
                                                        <div class="form-group row" style="margin-bottom: 10px;">
                                                            ...
                                                            <div class="col-sm-5 col-md-5">
                                                                <input type="text" class="form-control <?= form_error('nama_ayah') ? 'is-invalid' : (set_value('nama_ayah') ? 'is-valid' : null) ; ?>" name="nama_ayah" id="nama_ayah" style="margin-bottom: 0;" value="<?= set_value('nama_ayah'); ?>">
                                                        ...
                                                        <div class="form-group row" style="margin-bottom: 10px;">
                                                            <label for="pendidikan_terakhir" class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Pendidikan Terakhir</label>
                                                            <div class="col-sm-5 col-md-5">
                                                                <select class="form-control <?= form_error('pendidikan_terakhir') ? 'is-invalid' : null; ?>" name="pendidikan_terakhir" id="pendidikan_terakhir">
                                                                    <option value="" selected>Pilih Pendidikan Ayah</option>
                                                                    <option value="sd_sederajat" <?= "sd_sederajat" == set_value('pendidikan_terakhir') ? "selected" : null; ?>>SD / Sederajat</option>
                                                                    <option value="smp_sederajat" <?= "smp_sederajat" == set_value('pendidikan_terakhir') ? "selected" : null; ?>>SMP / Sederajat</option>
                                                                    <option value="sma_sederajat" <?= "sma_sederajat" == set_value('pendidikan_terakhir') ? "selected" : null; ?>>SMA / Sederajat</option>
                                                                    <option value="d1_d4" <?= "d1_d4" == set_value('pendidikan_terakhir') ? "selected" : null; ?>>D1/D2/D3/D4</option>
                                                                    <option value="s1" <?= "s1" == set_value('pendidikan_terakhir') ? "selected" : null; ?>>S1</option>
                                                                    <option value="s2" <?= "s2" == set_value('pendidikan_terakhir') ? "selected" : null; ?>>S2</option>
                                                                </select>
                                                        ...
                                                        <div class="form-group row" style="margin-bottom: 10px;">
                                                            ...
                                                            <div class="col-sm-5 col-md-5">
                                                                <textarea name="" id="" cols="30" rows="10" style="margin-bottom: 0;"></textarea>
                                                            </div>
                                                        </div>
                                                        <div class="form-group row" style="margin-bottom: 10px;">
                                                        ...
                                                        <div class="form-group row" style="margin-bottom: 10px;">
                                                            ...
                                                            <div class="col-sm-5 col-md-5">
                                                                <input type="text" class="form-control <?= form_error('kontak_ayah') ? 'is-invalid' : (set_value('kontak_ayah') ? 'is-valid' : null) ; ?>" name="kontak_ayah" id="kontak_ayah" style="margin-bottom: 0;" value="<?= set_value('kontak_ayah'); ?>">
                                                                <?= form_error('kontak_ayah', '<small class="text-danger pl-3">', '</small>'); ?>
                                                            </div>
                                                        </div>
                                                        <h3 class="fs-title" style="font-size: 17px;">Biodata Ibu :</h3>
                                                        <div class="form-group row">
                                                            <label for="nama_ibu" class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Nama Ayah</label>
                                                            <div class="col-sm-4 col-md-4">
                                                                <input type="text" class="form-control <?= form_error('nama_ibu') ? 'is-invalid' : (set_value('nama_ibu') ? 'is-valid' : null) ; ?>" name="nama_ibu" id="nama_ibu" style="margin-bottom: 0;" value="<?= set_value('nama_ibu'); ?>">
                                                        ...
                                                        <div class="form-group row" style="margin-bottom: 0;">
                                                            ...
                                                            <div class="col-sm-4 col-md-4">
                                                                <input type="text" style="margin-bottom: 0;" class="form-control <?= form_error('nama_ibu') ? 'is-invalid' : (set_value('nama_ibu') ? 'is-valid' : null) ; ?>" name="nama_ibu" id="nama_ibu" value="<?= set_value('nama_ibu'); ?>" >
                                                                <?= form_error('nama_ibu', '<small class="text-danger pl-3">', '</small>'); ?>
                                                            </div>
                                                        </div>
                                                    </div>
