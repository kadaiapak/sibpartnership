...
class Daftar_beasiswa_admin extends CI_Controller
{
    ...
    {
        $list = $this->daftar_beasiswa_admin->get_datatables($id);
        $data = array();
        $no = @$_POST['start'];
        ...
        $output = array(
                    "draw" => @$_POST['draw'],
                    "recordsTotal" => $this->daftar_beasiswa_admin->count_all($id),
                    "recordsFiltered" => $this->daftar_beasiswa_admin->count_filtered($id),
                    "data" => $data,
                );
