        ...
        <section class="section">
            ...
            <div class="section-body">
                ...
                <p class="section-lead">
                    halaman ini digunakan oleh admin Fakultas Universitas Negeri Padang untuk melakukan validasi.<br>
                </p>
                            ...
                            <div class="card-body">
                                ...
                                <div class="alert alert-light alert-has-icon p-4">
                                    ...
                                    <div class="alert-body">
                                        ...
                                        <p class="mt-3">
                                            <a href="<?= base_url('valfakultas/detail/'.$mb['id']); ?> " class="btn btn-success btn-xs"> <i class="fas fa-calendar-alt"></i> Lihat Daftar Mahasiswa</a>
                                        </p> 
                                    </div>
                                </div>
                                <?php endforeach ; ?>
