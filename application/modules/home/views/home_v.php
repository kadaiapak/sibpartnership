...
<head>
  ...
  <title>SIB - Partnership</title>
  <meta content="" name="description">
  <meta content="" name="keywords">

  <!-- Favicons -->
  <link href="assets/img/logo_unp.jpg" rel="icon">
...
<!-- untuk berita -->
  <link rel="stylesheet" href="<?= base_url(); ?>template/assets/css/materialdesignicons.min.css">
  <link rel="stylesheet" href="<?= base_url(); ?>template/assets/vendor/owl.carousel/dist/assets/owl.carousel.min.css"/>
  <link rel="stylesheet" href="<?= base_url(); ?>template/assets/vendor/owl.carousel/dist/assets/owl.theme.default.min.css"/>
  <link rel="stylesheet" href="<?= base_url(); ?>template/assets/css/styledua.css">
<!--  -->
  <!-- Vendor CSS Files -->
  ...
  <link href="<?= base_url(); ?>template/assets/css/home_style.css" rel="stylesheet">
...
<body>
  ...
  <header id="header" class="fixed-top ">
    <div class="container d-flex align-items-center justify-content-between">
      <h1 class="logo"><a href="index.html">SIB Partnership</a></h1>
        ...
        <ul>
          ...
          <li class="dropdown"><a href="#"><span>Beasiswa</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li><a href="#">Van Deventer-Maas Indonesia</a></li>
              <li><a href="#">Bank Indonesia</a></li>
              <li><a href="#">Bank Nagari</a></li>
              <li><a href="#"></a></li>
            </ul>
          </li>
          <li><a class="nav-link scrollto" href="#berita">Berita</a></li>
          <li><a class="nav-link scrollto " href="#portfolio">Daftar Beasiswa</a></li>
    ...
    <div class="container-fluid" data-aos="fade-up">
      <div class="row justify-content-center">
        <div class="col-xl-5 col-lg-6 pt-3 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1>Sistem Informasi Beasiswa - Partnership</h1>
          <h2>Membantu mahasiswa untuk mendaftar beasiswa</h2>
          <div><a href="#about" class="btn-get-started scrollto">Daftar Beasiswa</a></div>
        </div>
  ...
  <main id="main">
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content" data-aos="fade-right">
            <h3>Sistem Informasi Beasiswa - Partnership</h3>
            <p class="fst-italic">
              SIB Partnership merupakan sistem aplikasi yang berfungsi untuk memberikan kemudahan kepada mahasiswa untuk mendaftar dan mendapatkan bantuan biaya pendidikan.
            </p>
            <ul>
              <li><i class="bi bi-check-circle"></i> Mempermudah mahasiswa untuk mendapatkan informasi terbaru seputar beasiswa</li>
              <li><i class="bi bi-check-circle"></i> Mempermudah mahasiswa dalam mendaftar beasiswa</li>
              <li><i class="bi bi-check-circle"></i> Membantu mahasiswa untuk melihat status beasiswa mereka</li>
            </ul>
      ...
      <div class="container">
        ...
        <div class="row counters">
          ...
          <div class="col-lg-4 col-6 text-center">
            ...
            <p>Total Penerima Beasiswa</p>
          </div>

          <div class="col-lg-4 col-6 text-center">
            <span data-purecounter-start="0" data-purecounter-end="521" data-purecounter-duration="1" class="purecounter"></span>
            <p>Total Penerima Beasiswa tahun ini</p>
          </div>

          <div class="col-lg-4 col-6 text-center">
            <span data-purecounter-start="0" data-purecounter-end="1463" data-purecounter-duration="1" class="purecounter"></span>
            <p>Total Penerima Beasiswa Aktif</p>
          </div>
    ...
    <!-- ======= Services Section ======= -->
    <section id="berita" class="editors-news">
      <div class="row">
        <div class="col-lg-3">
    ...
    {{--End of News --}}
    <section id="daftar" class="services section-bg">
      <div class="container" data-aos="fade-up">
        <div class="section-title">
          <h2>Daftar beasiswa</h2>
          <p>Berikut beasiswa yang sedang buka pendaftaran</p>
        </div>
    ...
    <section id="faq" class="faq">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          ...
          <p>Pertanyaan - pertanyaan seputar Pendaftaran Beasiswa</p>
        </div>

        <div class="faq-list">
          <ul>
            <li data-aos="fade-up" data-aos="fade-up" data-aos-delay="100">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" class="collapse" data-bs-target="#faq-list-1">Bagaimana cara mendaftar beasiswa di Sistem Informasi Beasiswa<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-1" class="collapse show" data-bs-parent=".faq-list">
                <p>
                  Untuk mendaftar beasiswa, mahasiswa bisa klik daftar beasiswa pada beasiswa yang sedang membuka pendaftaran.
                </p>
              </div>
            </li>

            <li data-aos="fade-up" data-aos-delay="200">
              <i class="bx bx-help-circle icon-help"></i> <a data-bs-toggle="collapse" data-bs-target="#faq-list-2" class="collapsed">Apa saja persyaratan untuk mendaftar beasiswa<i class="bx bx-chevron-down icon-show"></i><i class="bx bx-chevron-up icon-close"></i></a>
              <div id="faq-list-2" class="collapse" data-bs-parent=".faq-list">
                <p>
                  Masing - masing beasiswa memiliki persyaratan yang berbeda beda tergantung beasiswa yang ingin di daftar
                </p>
              </div>
            </li>
    ...
    <section id="portfolio" class="portfolio">
      <div class="container" data-aos="fade-up">
        ...
        <div class="section-title">
          <h2>Galeri</h2>
          <p>Foto semua kegiatan mengenai beasiswa</p>
        </div>
